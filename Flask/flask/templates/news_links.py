...
sotrudniki_about = tree.xpath('//div[@class="field field--name-main-position field--type-entity-reference field--label-hidden field--item"]/text()')*2
...
videos_photo = tree.xpath('//div[@class="video-embed-field-provider-youtube video-embed-field-responsive-video form-group"]/iframe/@src')
videos_picture = []
...
with open("staff_OLD.html", 'r+', encoding='utf-8') as f1, open("staff.html", 'w+', encoding='utf-8') as f2:
    ...
    for line in x:
        if c<len(sotrudniki_photo):
            if FIND1 in line:
                f2.write('			<img src="https://physics.itmo.ru/'+str(sotrudniki_photo[d])+'" alt="Avatar" style="border-radius: 50%;">'+"\n")
                c+=1
                continue
            if FIND2 in line:
...
FIND2='<imggg'
FIND3='<pppp'
with open("science-groups_OLD.html", 'r+', encoding='utf-8') as f1, open("science-groups.html", 'w+', encoding='utf-8') as f2:
    x=f1.readlines()
    for line in x:
            if FIND1 in line:

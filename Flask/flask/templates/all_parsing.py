...
###### история ######
tree = kod("https://physics.itmo.ru/ru/history")
hist_ph=tree.xpath('//div[@class="field field--name-image field--type-image field--label-hidden field--item"]/iframe/@src')
print(hist_ph)
...
# print(len(sotrudniki_photo))
# print(len(sotrudniki_name1))
# print(len(sotrudniki_name2))
# print(len(sotrudniki_about))
...
#          <a href="/ru/news/vorkshop-s-predstavitelyami-biznesa-besprovodnye-tekhnologii-buduschego" >
